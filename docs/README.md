...
* [Tokenization rules](https://github.com/tim-hardcastle/pipefish/blob/main/docs/tokenization-rules.md) The exact rules of what makes a well-formed identifier. You probably don't need to read this.
...
* [Architecture](https://github.com/tim-hardcastle/pipefish/blob/main/docs/tokenization-rules.md). How Pipefish compiles and runs a script.
