...
var StandardLibraries = dtypes.MakeFromSlice([]string{"files", "fmt", "html", "math", "math/rand", "math/big", "path", "path/filepath", "reflect", "regexp", "sql", "strings", "terminal", "time", "unicode"})
