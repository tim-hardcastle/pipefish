...
// Update with:
var ALL_CONSTANT_ACCESS = dtypes.SetOf(GLOBAL_CONSTANT_PUBLIC, GLOBAL_CONSTANT_PRIVATE, LOCAL_CONSTANT, VERY_LOCAL_CONSTANT)
var ALL_PRIVATE_ACCESS = dtypes.SetOf(GLOBAL_CONSTANT_PRIVATE, GLOBAL_VARIABLE_PRIVATE)
